...
import { WEBSTIE_PRODUCT_DETAILS } from "@/routes/WebsiteRoute";
                        ...
                        <div className="flex items-center gap-5">
                          ...
                          <div>
                            <h4 className="text-lg line-clamp-1">
                              ...
                              <p>Size: {product?.variantId?.color}</p>
                            </h4>
                          </div>
                        </div>
                      </td>
                ...
                <div>
                  <table className="w-full">
                    <tbody>
                      ...
                      <tr>
                        <td className="font-medium py-2">Lankmark</td>
                        <td className="text-end py-2">{orderData?.lankmark}</td>
                      </tr>
                      <tr>
              ...
              <div className="p-5 bg-gray-50 dark:bg-card">
                ...
                <div className="pt-3">
                  ...
                  <Select
                    ...
                    isMulti={false}
                  />
                  <ButtonLoading type={"button"} onClick={handleOrderStatus} />
                </div>
              </div>
            </div>
          </div>
